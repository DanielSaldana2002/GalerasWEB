...
<body>
    ...
    <div id='size-imagen'>
        <div id='title-message-box'>
            <h1>ERROR REGISTRO DE ALMACEN</h1>
            <p>El nombre del ingrediente que intentas registrar ya existe.</p>
            <button><a href="/php/galeon/views/registroAlmacen.php">Regresar a Registro</a></button>
        </div>
