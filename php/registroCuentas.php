...
<head>
    ...
    <link rel="stylesheet" href="/style/registroCuentas.css">
    <title>Registro de cuentas | Galeon</title>
</head>
<body>
    <div id="boxRegistro">
        <form action="/php/verificacionCuentas.php" method="post" id="formularioRegistro">
            ...
            <input type="text" name="UsuarioUser" id="UsuarioUserID" placeholder="Usuario" autocomplete="off" required></br>
            <input type="text" name="passwordUser" id="passwordUserID" placeholder="Contraseña" autocomplete="off" required></br>
